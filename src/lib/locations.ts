...
// ─────────────────── ТЗ №17 §3.2 / §10.8 — формат адреса ────────────────────

/**
 * Единый формат адреса по всей системе: «Блок A1 · ориентир 5».
 *
 * ТЗ №17 §10.8 — «формат адреса одинаков в поиске, продаже, отгрузках,
 * разбитии». До этого в коде жили три варианта одновременно («Блок X,
 * ориентир Y», «Блок X, ор. Y», «блок X, ориентир Y»), и один и тот же адрес
 * выглядел по-разному на соседних экранах — складчик каждый раз перечитывал.
 *
 * Точка с запятой между «блоком» и «ориентиром» именно «·»: он визуально
